...
# need to pip install ahuora_compounds@git+https://github.com/waikato-ahuora-smart-energy-systems/PropertyPackages.git@v0.0.26
...
m.fs.dsi.inlet.mole_frac_comp[0,"water"].fix(0.99)
m.fs.dsi.inlet.mole_frac_comp[0,"milk_solid"].fix(0.01)

m.fs.dsi.steam_inlet.flow_mol.fix(1)
m.fs.dsi.properties_steam_in[0].constrain_component(m.fs.dsi.properties_steam_in[0].temperature, 300 * pyo.units.K)
...
print("Mole Fraction (Liquid Phase, Water):", pyo.value(dsi.properties_milk_in[0.0].mole_frac_phase_comp["Liq", "water"]))
print("Mole Fraction (Vapor Phase, Water):", pyo.value(dsi.properties_milk_in[0.0].mole_frac_phase_comp["Vap", "water"]))
...
print("Mole Fraction (Liquid Phase, Water):", pyo.value(dsi.properties_steam_in[0.0].mole_frac_phase_comp["Liq", "water"]))
print("Mole Fraction (Vapor Phase, Water):", pyo.value(dsi.properties_steam_in[0.0].mole_frac_phase_comp["Vap", "water"]))
print("steam_cooled")
...
print("Mole Fraction (Liquid Phase, Water):", pyo.value(dsi.properties_steam_cooled[0.0].mole_frac_phase_comp["Liq", "water"]))
print("Mole Fraction (Vapor Phase, Water):", pyo.value(dsi.properties_steam_cooled[0.0].mole_frac_phase_comp["Vap", "water"]))
print("steam_delta_h")
...
print("Mole Fraction (Liquid Phase, Water):", pyo.value(dsi.properties_mixed_unheated[0.0].mole_frac_phase_comp["Liq", "water"]))
print("Mole Fraction (Vapor Phase, Water):", pyo.value(dsi.properties_mixed_unheated[0.0].mole_frac_phase_comp["Vap", "water"]))
...
print("Mole Fraction (Liquid Phase, Water):", pyo.value(dsi.properties_out[0.0].mole_frac_phase_comp["Liq", "water"]))
print("Mole Fraction (Vapor Phase, Water):", pyo.value(dsi.properties_out[0.0].mole_frac_phase_comp["Vap", "water"]))
